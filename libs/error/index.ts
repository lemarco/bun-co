...
type ErrorData = { message: string; code: number }
...
export const propOrDefault = partialRight(partial(propOr, [getBadRequestError()]), [getErrorCodes()])

export const getErrorWithDefaultError = ({ code }: Error) => propOrDefault(String(code)) as ErrorData
